...
class FacultyTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier("professor_cell", forIndexPath: indexPath)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "faculty_segue" {
            if let professorTVC = segue.destinationViewController as? ProfessorInfoViewController {
                professorTVC.professor = department.faculty[(self.tableView.indexPathForSelectedRow?.row)!]
            }
        }
    }
